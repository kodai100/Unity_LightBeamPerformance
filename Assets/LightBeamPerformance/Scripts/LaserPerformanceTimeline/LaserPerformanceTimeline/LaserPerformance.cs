...
namespace ProjectBlue.LightBeamPerformance
{
    ...
    {
        [Header("Initial Settings")] [Header("Editable in Timeline")]
        public LaserColorMode LaserColorMode = LaserColorMode.Gradient;
        ...
        {
            laserGroups.ForEach(laserGroup => { laserGroup.Lasers.ForEach(laser => { laser.Initialize(); }); });
        ...
        public void ProcessFrame(double masterTime, double clipTime)
        {
            ...
            laserGroups.ForEach(group =>
            {
                group.Lasers.ForEach(laser =>
                {
                    ...
                    laser.LaserGradient = LaserGradient;
